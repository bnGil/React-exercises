...
class Q1 extends React.Component {
  render() {
    return <div className="question-1-container">{this.props.children}</div>;
  }
}
...
class Q2 extends React.Component {
  render() {
    return <div className="question-2-container">{this.props.children}</div>;
  }
}
...
class Exercise3_2 extends React.Component {
  render() {
    return (
      <Quiz>
        <QuizTitle></QuizTitle>
